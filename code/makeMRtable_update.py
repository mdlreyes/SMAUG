...
def makeTables(tablename, outfilepath='/Users/miadelosreyes/Documents/Research/SF/ForPaper/Tables/'):
	"""Code to make tables.
	...
	database = '/Users/miadelosreyes/Documents/Research/SF/ForPaper/masterfile_new.csv'
	data = pd.read_csv(database, delimiter=',', dtype='str')
